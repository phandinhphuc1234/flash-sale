...
$secretMappings = @(
  ...
  @{ Name = "cart-secrets"; Entries = @(@("SPRING_DATASOURCE_USERNAME", "POSTGRES_USER"), @("SPRING_DATASOURCE_PASSWORD", "POSTGRES_PASSWORD"), @("CART_CLIENT_SECRET", "CART_CLIENT_SECRET")) },
  @{ Name = "order-secrets"; Entries = @(@("SPRING_DATASOURCE_USERNAME", "POSTGRES_USER"), @("SPRING_DATASOURCE_PASSWORD", "POSTGRES_PASSWORD"), @("ORDER_CLIENT_SECRET", "ORDER_CLIENT_SECRET")) },
