...
**Tests**: Include every test and validation required by the specification, plan, contracts, and
constitution. Required validation is never optional.
...
### Tests for User Story 2 *(include applicable unit, integration, contract, and load tests)*
...
### Tests for User Story 3 *(include applicable unit, integration, contract, and load tests)*
