...
The runner discovers the host from the Kubernetes `api-gateway` Service and uses bounded DNS/HTTP
timeouts. It must not print Authorization headers or any Secret value.
